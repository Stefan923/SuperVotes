...
public abstract class AbstractCommand {
    ...
    protected abstract ReturnType runCommand(SuperVotes instance, CommandSender sender, String... args) throws MissingPermissionException;

    protected abstract List<String> onTab(SuperVotes instance, CommandSender sender, String... args);
